...
export default async function decorate(block) {
  ...
  topBar.innerHTML = '<div></div><div class="header-markets"><span><a href="/user-form">Sign In</a></span><span class="icon icon-flag-us"></span>EN-US<span class="header-chevron-down"></span></div>';
